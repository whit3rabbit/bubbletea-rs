...
use progress_download_main::{
    AnimatedProgressBar, DownloadSimulator, DownloadTickMsg, FinalPauseMsg, ProgressDownloadModel,
    ProgressErrMsg, ProgressFrameMsg, ProgressMsg,
};
